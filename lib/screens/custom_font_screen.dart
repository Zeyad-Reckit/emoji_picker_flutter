...
/// Example Screen for EmojiPicker with Google Emoji Fonts
class CustomFontScreen extends StatefulWidget {
  const CustomFontScreen({super.key});

  @override
  CustomFontScreenState createState() => CustomFontScreenState();
}

class CustomFontScreenState extends State<CustomFontScreen> {
