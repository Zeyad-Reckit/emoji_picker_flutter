...
/// Example Screen for EmojiPicker with EmojiPickerController
class ControllerExampleScreen extends StatefulWidget {
  const ControllerExampleScreen({super.key});

  @override
  ControllerExampleScreenState createState() => ControllerExampleScreenState();
}

class ControllerExampleScreenState extends State<ControllerExampleScreen> {
